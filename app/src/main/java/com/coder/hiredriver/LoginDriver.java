...
public class LoginDriver extends AppCompatActivity {
        ...
        mGoogleApiClient = new GoogleApiClient.Builder(getApplicationContext())
                .enableAutoManage(this, new GoogleApiClient.OnConnectionFailedListener() {
                    ...
                    public void onConnectionFailed(@NonNull ConnectionResult connectionResult) {
                        Toast.makeText(LoginDriver.this, "Login Unsuccesful", Toast.LENGTH_LONG).show();
                    }
                })
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                if (firebaseAuth.getCurrentUser() != null) {
                    startActivity(new Intent(LoginDriver.this, DriverDashboard.class));
                }
            }
        };
    ...
    public void CustSign(View v) {
        ...
        if (TextUtils.isEmpty(email) || TextUtils.isEmpty(password)) {
            Toast.makeText(LoginDriver.this, "Fields are empty", Toast.LENGTH_LONG).show();
        } else {
    ...
    public void signupMethod(View v) {
        startActivity(new Intent(LoginDriver.this, DriverSignUp.class));
    }
